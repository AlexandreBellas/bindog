                ...
                <div className="flex items-center justify-between gap-3">
                    <div className="flex min-w-0 items-center gap-1.5">
                        ...
                        <Tooltip delayDuration={200}>
                            <TooltipTrigger
                                type="button"
                                className="inline-flex size-6 shrink-0 items-center justify-center rounded-full text-(--bark-soft) outline-none hover:text-(--bark) focus-visible:ring-[3px] focus-visible:ring-ring/50"
                                aria-label={m.setting_info_aria()}
                            >
                                <CircleHelp className="size-4" />
                            </TooltipTrigger>
                            <TooltipContent className="max-w-xs text-left">
                                {m.setting_full_grid_tooltip()}
                            </TooltipContent>
                        </Tooltip>
                    </div>
                    <Switch
                ...
                <div className="flex items-center justify-between gap-3">
                    <div className="flex min-w-0 items-center gap-1.5">
                        ...
                        <Tooltip delayDuration={200}>
                            ...
                            <TooltipContent className="max-w-xs text-left">
                                {m.setting_limit_bindogs_tooltip()}
                            </TooltipContent>
                        </Tooltip>
                    </div>
                    <Switch
